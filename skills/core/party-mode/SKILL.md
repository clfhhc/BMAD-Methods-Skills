...
Load config from `{skill-config}/core/config.yaml` and resolve:

- `project_name`, `output_folder`, `user_name`
- `communication_language`, `document_output_language`, `user_skill_level`
- `date` as a system-generated value
- Agent manifest path: `{skill-config}/agent-manifest.csv`

### Paths

- `installed_path` = `../../core/party-mode`
- `agent_manifest_path` = `{skill-config}/agent-manifest.csv`
