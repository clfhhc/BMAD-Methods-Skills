...
## When to Use
This workflow can be run standalone and is designed for: tri-modal workflow for creating, editing, and validating bmad core compliant agents
...
Load and read full config from `{skill-config}/bmb/config.yaml`:
