...
- [ ] Workflow paths use: `../../{module-code}/...`
...
- [ ] Has sidecar folder
- [ ] Uses `exec:` for workflow references
- [ ] Sidecar paths use `{runtime-memory}/{sidecar-folder}/` format
...
**Fix:** `exec: '../../bmm/create-prd/SKILL.md'`
