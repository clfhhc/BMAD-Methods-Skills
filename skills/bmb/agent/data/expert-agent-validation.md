...
- [ ] **Loads sidecar memories:** `{runtime-memory}/{sidecar-folder}/memories.md`
- [ ] **Loads sidecar instructions:** `{runtime-memory}/{sidecar-folder}/instructions.md`
- [ ] **Restricts file access:** `ONLY read/write files in {runtime-memory}/{sidecar-folder}/`
...
- [ ] ALL sidecar paths use: `{runtime-memory}/{sidecar-folder}/...`
...
- [ ] References from agent YAML to sidecar use `{runtime-memory}/` format
...
**Fix:** `{runtime-memory}/journal-keeper-sidecar/memories.md`
