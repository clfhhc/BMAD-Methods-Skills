...
critical_actions:
  ...
  - 'Load COMPLETE file {runtime-memory}/journal-keeper-sidecar/instructions.md'
...
menu:
  ...
  - trigger: QC or fuzzy match on quick-capture
    action: 'Save entry to {runtime-memory}/journal-keeper-sidecar/entries/entry-{date}.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '../../bmm/workflow-status/SKILL.md'
...
6. **Expert sidecars:** `{runtime-memory}/{sidecar-folder}/`
