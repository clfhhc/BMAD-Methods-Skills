...
## When to Use
This workflow can be run standalone and is designed for: create structured standalone workflows using markdown-based step architecture (tri-modal: create, validate, edit)
...
Load and read full config from {skill-config}/bmb/config.yaml and resolve:
