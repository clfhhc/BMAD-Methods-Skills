...
- Execute ../../core/advanced-elicitation/SKILL.md with the current design direction content
...
- Execute ../../core/party-mode/SKILL.md with the current design direction
