...
- Execute ../../core/advanced-elicitation/SKILL.md with the current visual foundation content
...
- Execute ../../core/party-mode/SKILL.md with the current visual foundation
