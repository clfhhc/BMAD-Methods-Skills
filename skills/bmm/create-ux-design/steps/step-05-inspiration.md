...
- Execute ../../core/advanced-elicitation/SKILL.md with the current inspiration analysis content
...
- Execute ../../core/party-mode/SKILL.md with the current inspiration analysis
