...
- Execute ../../core/advanced-elicitation/SKILL.md with the current component strategy content
...
- Execute ../../core/party-mode/SKILL.md with the current component strategy
