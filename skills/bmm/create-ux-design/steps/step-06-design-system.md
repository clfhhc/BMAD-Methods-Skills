...
- Execute ../../core/advanced-elicitation/SKILL.md with the current design system content
...
- Execute ../../core/party-mode/SKILL.md with the current design system choice
