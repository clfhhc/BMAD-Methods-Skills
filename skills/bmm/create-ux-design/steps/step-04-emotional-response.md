...
- Execute ../../core/advanced-elicitation/SKILL.md with the current emotional response content
...
- Execute ../../core/party-mode/SKILL.md with the current emotional response definition
