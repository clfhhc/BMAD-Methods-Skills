...
Load config from `{skill-config}/bmm/config.yaml` and resolve:
...
- `installed_path` = `../../bmm/quick-dev`
- `project_context` = `**/project-context.md` (load if exists)
- `project_levels` = `../../bmm/workflow-status/project-levels.yaml`

### Related Workflows

- `quick_spec_workflow` = `../../bmm/quick-spec/SKILL.md`
- `workflow_init` = `../../bmm/workflow-status/init/workflow.yaml`
- `party_mode_exec` = `../../core/party-mode/SKILL.md`
- `advanced_elicitation` = `../../core/advanced-elicitation/SKILL.md`
